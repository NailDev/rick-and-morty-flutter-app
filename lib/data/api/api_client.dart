  ...
  List<Character> _getMockCharacters(int page) {
    if (page == 1) {
      return [
        ...
        Character(id: 3, name: 'Summer Smith', status: 'Alive', species: 'Human', gender: 'Female', image: 'https://i.pinimg.com/474x/c9/78/c3/c978c37147ccddb74d74212117eab4eb.jpg?nii=t', location: 'Earth (Replacement Dimension)'),
        ...
        Character(id: 5, name: 'Jerry Smith', status: 'Alive', species: 'Human', gender: 'Male', image: 'https://2x2tv.ru/upload/iblock/f33/f33fa082417e7f6a597cfeda6c824c6e.jpg', location: 'Earth (Replacement Dimension)'),
        Character(id: 6, name: 'Abadango Cluster Princess', status: 'Alive', species: 'Alien', gender: 'Female', image: 'https://i.pinimg.com/736x/68/2d/aa/682daa2328fc1b1b0dd9f1d67352c265.jpg', location: 'Abadango'),
        ...
        Character(id: 16, name: 'Amish Cyborg', status: 'Dead', species: 'Alien', gender: 'Male', image: 'https://images.kinorium.com/movie/shot/625877/w1500_52114870.jpg', location: 'Earth (Replacement Dimension)'),
        Character(id: 17, name: 'Annie', status: 'Alive', species: 'Human', gender: 'Female', image: 'https://i.pinimg.com/736x/62/ff/9f/62ff9ff824e742b3beb96cbd991cf136.jpg', location: 'Anatomy Park'),
